...
- PR #10809: https://github.com/ingbyr/lzcode/pull/10809
- PR #11496: https://github.com/ingbyr/lzcode/pull/11496

## Do Not Translate (Locale Additions)

- `LzCode` (preserve casing in prose; keep `opencode` only in commands, package names, paths, or code)
- `LzCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
