...
- PR #15835: https://github.com/ingbyr/lzcode/pull/15835

## Do Not Translate (Locale Additions)

- `LzCode` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `LzCode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `LzCode` inside commands, URLs, package names, or code literals
