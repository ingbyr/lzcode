export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av LzCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av LzCode er lastet ned. Vil du installere den og starte på nytt?",
