export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'LzCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'LzCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
