export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju LzCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} LzCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
