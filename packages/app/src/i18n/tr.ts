...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler lzcode.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (lzcode.json) sağlayıcı/model adlarını kontrol edin",
