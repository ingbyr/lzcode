export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans lzcode.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (lzcode.json) pour les noms de fournisseur/modèle",
