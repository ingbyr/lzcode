...
export const dict = {
  ...
  "dialog.plugins.empty": "In lzcode.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (lzcode.json) auf Anbieter-/Modellnamen",
