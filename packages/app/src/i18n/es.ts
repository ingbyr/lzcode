export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en lzcode.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (lzcode.json)",
