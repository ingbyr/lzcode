...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "LzCode Documentation", href: "https://www.kdocs.cn/l/ctaJKnugXzIO" },
      { type: "item", label: "Support Forum", href: "https://github.com/ingbyr/lzcode/issues" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/ingbyr/lzcode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/ingbyr/lzcode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
