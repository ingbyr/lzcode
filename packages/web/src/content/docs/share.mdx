---
title: Share
description: Share your LzCode conversations.
---

LzCode's share feature allows you to create public links to your LzCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, LzCode:
...
LzCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, LzCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
