...
You can add custom commands through the LzCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your LzCode [config](/docs/config):
