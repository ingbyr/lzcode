...
With LzCode you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, LzCode uses our own `opencode` theme.
...
LzCode comes with several built-in themes.
...
- Want LzCode to match their terminal's appearance
...
LzCode supports a flexible JSON-based theme system that allows users to create and customize themes easily.
