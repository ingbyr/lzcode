---
title: TUI
description: Using the LzCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LzCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running LzCode starts the TUI for the current directory.
...
When using the LzCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to LzCode. Allows you to select from available providers and add their API keys.
