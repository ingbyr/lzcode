---
title: LSP Servers
description: LzCode integrates with your LSP servers.
---

LzCode integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

LzCode comes with several built-in LSP servers for popular languages:
