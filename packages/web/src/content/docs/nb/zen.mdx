---
title: Zen
description: Utvalgt liste over modeller levert av LzCode.
---
...
LzCode Zen er en liste over testede og verifiserte modeller levert av LzCode-teamet.

:::note
LzCode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i LzCode. Du logger på LzCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med LzCode.
:::
...
LzCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

LzCode Zen fungerer som alle andre leverandører i LzCode.

1. Du logger på **<a href={console}>LzCode Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger LzCode Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i LzCode-konfigurasjonen
...
- MiniMax M2.5 Free er tilgjengelig på LzCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på LzCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med LzCode også.
