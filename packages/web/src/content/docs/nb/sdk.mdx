---
title: SDK
description: Typesikker JS-klient for LzCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

LzCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere LzCode programmatisk.
...
Opprett en forekomst av LzCode:
...
Hvis du allerede har en kjørende forekomst av LzCode, kan du opprette en klientforekomst for å koble til den:
