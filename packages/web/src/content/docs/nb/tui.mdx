...
LzCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre LzCode starter TUI for gjeldende katalog.
...
Når du bruker LzCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til LzCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt LzCode. _Aliaser_: `/quit`, `/q`
