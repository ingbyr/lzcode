...
description: Lag verktøy som LLM kan kalle inn LzCode.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med LzCode sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
