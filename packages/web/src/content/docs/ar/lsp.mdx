---
title: خوادم LSP
description: يتكامل LzCode مع خوادم LSP لديك.
---

يتكامل LzCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي LzCode مع عدة خوادم LSP مدمجة للغات الشائعة:
