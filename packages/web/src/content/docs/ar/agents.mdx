...
يستخدم معرّف النموذج في إعدادات LzCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [LzCode Zen](/docs/zen)، فستستخدم `opencode/gpt-5.1-codex` لـ GPT 5.1 Codex.
