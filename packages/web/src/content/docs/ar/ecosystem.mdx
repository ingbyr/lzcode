---
title: النظام البيئي
description: مشاريع وتكاملات مبنية باستخدام LzCode.
---

مجموعة من مشاريع المجتمع المبنية على LzCode.

:::note
هل تريد إضافة مشروعك المتعلق بـ LzCode إلى هذه القائمة؟ أرسل طلب سحب (PR).
:::
...
| الاسم                                                                                              | الوصف                                                                                                          |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | تشغيل جلسات LzCode تلقائيًا في صناديق حماية Daytona معزولة مع مزامنة git ومعاينات حية                          |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | تتبع استخدام LzCode باستخدام Wakatime                                                                          |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | إشعارات سطح المكتب وتنبيهات صوتية لجلسات LzCode                                                                |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | تسمية جلسات Zellij تلقائيًا بدعم الذكاء الاصطناعي بناءً على سياق LzCode                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | السماح لوكلاء LzCode بتحميل المطالبات (prompts) بشكل كسول عند الطلب مع اكتشاف المهارات وحقنها                  |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | إشعارات نظام التشغيل الأصلية لـ LzCode – اعرف متى تكتمل المهام                                                 |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | حزمة تنسيق متعددة الوكلاء – 16 مكونًا، تثبيت واحد                                                              |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | أشجار عمل git (worktrees) خالية من الاحتكاك لـ LzCode                                                          |
...
| الاسم                                                                                      | الوصف                                                                     |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | بوت Discord للتحكم في جلسات LzCode، مبني على SDK                          |
| [opencode.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | إضافة Neovim للمطالبات المدركة للمحرر، مبنية على API                      |
| [portal](https://github.com/hosenur/portal)                                                | واجهة ويب مخصصة للجوال لـ LzCode عبر Tailscale/VPN                        |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | قالب لبناء إضافات LzCode                                                  |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | موفر Vercel AI SDK لاستخدام LzCode عبر @opencode-ai/sdk                   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | تطبيق ويب / سطح مكتب وامتداد VS Code لـ LzCode                            |
| [LzCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                             | إضافة Obsidian تدمج LzCode في واجهة مستخدم Obsidian                       |
| [OpenWork](https://github.com/different-ai/openwork)                                       | بديل مفتوح المصدر لـ Claude Cowork، مدعوم بواسطة LzCode                   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | مدير امتدادات LzCode مع ملفات تعريف محمولة ومعزولة.                       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | تطبيق عميل لسطح المكتب والويب والجوال وعن بعد لـ LzCode                   |
