---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها LzCode.
---
...
LzCode Zen هي قائمة بالنماذج التي اختبرها فريق LzCode وتحقّق منها.

:::note
LzCode Zen متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في LzCode. تسجّل الدخول إلى LzCode Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام LzCode.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع LzCode.
:::
...
LzCode Zen هو بوابة للذكاء الاصطناعي تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل LzCode Zen مثل أي مزوّد آخر في LzCode.

1. تسجّل الدخول إلى **<a href={console}>LzCode Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار LzCode Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات LzCode الصيغة `opencode/<model-id>`.
...
- MiniMax M2.5 Free متاح على LzCode لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على LzCode لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. عدم فرض **أي ارتباط حصري (lock-in)** عبر تمكينك من استخدامه مع أي عامل برمجة آخر، مع إتاحة استخدام أي مزوّد آخر مع LzCode أيضا.
