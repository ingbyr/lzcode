...
OpenCode Zen هي قائمة نماذج يوفّرها فريق LzCode وقد تم
...
OpenCode Zen هي قائمة من النماذج التي تم اختبارها والتحقق منها مقدّمة من فريق LzCode. [اعرف المزيد](/docs/zen).
