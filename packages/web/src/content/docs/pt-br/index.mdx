...
Você também pode baixar o binário na seção [Releases](https://github.com/ingbyr/lzcode/releases).
...
Se você é novo no uso de provedores de LLM, recomendamos usar o [LzCode Zen](/docs/zen).
