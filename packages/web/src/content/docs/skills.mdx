...
Agent skills let LzCode discover reusable instructions from your repo or home directory.
...
LzCode searches these locations:
...
For project-local paths, LzCode walks up from your current working directory until it reaches the git worktree.
...
LzCode lists available skills in the `skill` tool description.
