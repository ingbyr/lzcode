---
title: SDK
description: Typowany klient JS dla serwera LzCode.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS LzCode zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli LzCode.
...
Jeśli masz już działającą instancję LzCode, możesz utworzyć instancję klienta, aby się z nią połączyć:
