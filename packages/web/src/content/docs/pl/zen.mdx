---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez LzCode.
---
...
LzCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół LzCode.

:::note
LzCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w LzCode. Logujesz się do LzCode Zen i otrzymujesz
...
LzCode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

LzCode Zen działa jak każdy inny dostawca w LzCode.

1. Logujesz się do **<a href={console}>LzCode Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz LzCode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji LzCode
...
- MiniMax M2.5 Free jest dostępny w LzCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w LzCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w LzCode.
