...
Możesz także pobrać plik binarny z [Releases](https://github.com/ingbyr/lzcode/releases).
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [LzCode Zen](/docs/zen).
