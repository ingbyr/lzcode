...
Du kan tilføje brugerdefinerede kommandoer gennem LzCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din LzCode [config](/docs/config):
