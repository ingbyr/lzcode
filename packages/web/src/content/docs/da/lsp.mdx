---
title: LSP-servere
description: LzCode integreres med dine LSP-servere.
---

LzCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

LzCode leveres med flere indbyggede LSP-servere til populære sprog:
