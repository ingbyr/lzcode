...
OpenCode Zen er en liste over modeller leveret af LzCode-teamet, som er blevet testet og verificeret til at fungere godt med LzCode. [Læs mere](/docs/zen).
...
OpenCode Zen er en liste over testede og verificerede modeller leveret af LzCode-teamet. [Læs mere](/docs/zen).
