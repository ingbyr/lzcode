...
Der er to typer agenter i LzCode; primære agenter og subagenter.
...
LzCode leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
LzCode leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

LzCode leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Hvis ingen temperatur er angivet, bruger LzCode modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale LzCode-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din LzCode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [OpenCode Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/ingbyr/lzcode).
:::
