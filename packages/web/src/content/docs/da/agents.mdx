...
Model-id'et i din LzCode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [LzCode Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
