---
title: Zen
description: Udvalgt liste over modeller leveret af LzCode.
---
...
LzCode Zen er en liste over testede og verificerede modeller leveret af LzCode-teamet.

:::note
LzCode Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i LzCode. Du logger på LzCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med LzCode.
:::
...
LzCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

LzCode Zen fungerer som alle andre udbydere i LzCode.

1. Du logger på **<a href={console}>LzCode Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger LzCode Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i LzCode-konfigurationen
...
- MiniMax M2.5 Gratis er tilgængelig på LzCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på LzCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede LzCode Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med LzCode også.
