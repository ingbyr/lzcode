---
title: TUI
description: Brug af LzCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LzCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre LzCode starter TUI for den nuværende mappe.
...
Når du bruger LzCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til LzCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut LzCode. _Aliaser_: `/quit`, `/q`
