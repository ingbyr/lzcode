...
Agentferdigheter lar LzCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
LzCode søker etter disse stedene:
...
For prosjektlokale stier går LzCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
LzCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
