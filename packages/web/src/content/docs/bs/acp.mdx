---
title: ACP podrška
description: Koristite LzCode u bilo kojem uređivaču kompatibilnom sa ACP.
---

LzCode podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili LzCode putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `opencode acp`.

Naredba pokreće LzCode kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "LzCode" agenta u AI Chat agent selektoru.
...
Da koristite LzCode kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi LzCode kao ACP chat agenta.
...
LzCode radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj LzCode konfiguraciji
