...
OpenCode Zen je lista modela koje je obezbedio LzCode tim koji su bili
...
OpenCode Zen je lista testiranih i verifikovanih modela koju je obezbedio LzCode tim. [Saznajte više](/docs/zen).
