---
title: TUI
description: Korištenje korisničkog interfejsa LzCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LzCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje LzCode pokreće TUI za trenutni direktorij.
...
Kada koristite LzCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u LzCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz LzCode. _Aliases_: `/quit`, `/q`
