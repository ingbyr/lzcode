---
title: Zen
description: Kurirana lista modela koje nudi LzCode.
---
...
LzCode Zen je lista testiranih i provjerenih modela koje obezbjeduje LzCode tim.

:::note
LzCode Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u LzCode. Prijavite se u LzCode Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili LzCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s LzCode.
:::
...
LzCode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

LzCode Zen radi kao i svaki drugi provajder u LzCode.

1. Prijavite se na **<a href={console}>LzCode Zen</a>**, dodajte billing podatke i kopirajte API kljuc.
2. U TUI-ju pokrenite `/connect`, izaberite LzCode Zen i zalijepite API kljuc.
...
[model id](/docs/config/#models) u LzCode konfiguraciji koristi format `opencode/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `opencode/gpt-5.2-codex`.
...
- MiniMax M2.5 Free je dostupan na LzCode ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
- Big Pickle je stealth model koji je besplatan na LzCode ograniceno vrijeme. Tim koristi taj period za prikupljanje povratnih informacija i poboljsanje modela.
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u LzCode.
