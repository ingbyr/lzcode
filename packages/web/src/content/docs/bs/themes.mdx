...
U LzCode mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, LzCode koristi nasu `opencode` temu.
...
LzCode dolazi sa vise ugradenih tema.
...
- Zele da LzCode odgovara izgledu njihovog terminala
...
LzCode podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
