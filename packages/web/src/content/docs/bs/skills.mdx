...
Agent skills omogucavaju LzCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
LzCode pretrazuje ove lokacije:
...
Za projektne lokalne putanje, LzCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
LzCode navodi dostupne skills u opisu `skill` alata.
