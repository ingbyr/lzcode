---
title: LSP serveri
description: LzCode se integriše sa vašim LSP serverima.
---

LzCode se integriše sa vašim Language Server Protocol (LSP) serverima kako bi pomogao LLM-u u interakciji s kodnom bazom. Koristi dijagnostiku za slanje povratnih informacija modelu.

## Ugrađeni

LzCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
