...
Vous pouvez ajouter des commandes personnalisées via la configuration LzCode ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre LzCode [config](/docs/config) :
