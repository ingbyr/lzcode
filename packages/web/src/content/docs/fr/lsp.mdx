---
title: Serveurs LSP
description: LzCode s'intègre à vos serveurs LSP.
---

LzCode s'intègre via le protocole LSP (Language Server Protocol) pour aider le LLM à interagir avec votre base de code. Il utilise des diagnostics pour fournir des commentaires au LLM.

---

## Serveurs intégrés

LzCode est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
