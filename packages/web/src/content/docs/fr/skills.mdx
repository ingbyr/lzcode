...
Les compétences d'agent permettent à LzCode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
LzCode recherche ces emplacements :
...
Pour les chemins locaux du projet, LzCode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
LzCode répertorie les compétences disponibles dans la description de l'outil `skill`.
