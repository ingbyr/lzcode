---
title: TUI
description: Utilisation de l’interface utilisateur du terminal LzCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LzCode fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de LzCode démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le LzCode TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à LzCode. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
