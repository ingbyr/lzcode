---
title: Zen
description: Lista seleccionada de modelos proporcionada por LzCode.
---
...
LzCode Zen es una lista de modelos probados y verificados proporcionada por el equipo LzCode.

:::note
LzCode Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en LzCode. Inicias sesion en LzCode Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar LzCode.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con LzCode.
:::
...
LzCode Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

LzCode Zen funciona como cualquier otro proveedor en LzCode.

1. Inicias sesión en **<a href={console}>LzCode Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona LzCode Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de LzCode
...
- MiniMax M2.5 Free está disponible en LzCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en LzCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con LzCode también.
