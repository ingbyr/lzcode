---
title: TUI
description: Usando la interfaz de usuario del terminal LzCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LzCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar LzCode se inicia TUI para el directorio actual.
...
Cuando utilice LzCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a LzCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de LzCode. _Alias_: `/quit`, `/q`
