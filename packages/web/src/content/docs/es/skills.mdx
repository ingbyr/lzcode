...
Las habilidades del agente permiten a LzCode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
LzCode busca estas ubicaciones:
...
Para las rutas locales del proyecto, LzCode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
LzCode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
