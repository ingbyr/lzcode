...
Con LzCode puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, LzCode usa nuestro propio tema `opencode`.
...
LzCode viene con varios temas integrados.
...
- Quiere que LzCode coincida con la apariencia de su terminal
...
LzCode admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
