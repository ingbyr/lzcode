...
Puede agregar comandos personalizados a través de la configuración LzCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su LzCode [config](/docs/config):
