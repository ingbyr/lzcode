---
title: Compartir
description: Comparte tus conversaciones LzCode.
---

La función para compartir de LzCode te permite crear enlaces públicos a tus conversaciones de LzCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, LzCode:
...
LzCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, LzCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
