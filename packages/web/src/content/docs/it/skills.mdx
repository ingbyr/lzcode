...
Le skill degli agenti permettono a LzCode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
LzCode cerca in queste posizioni:
...
Per i percorsi locali al progetto, LzCode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
LzCode elenca le skill disponibili nella descrizione dello strumento `skill`.
