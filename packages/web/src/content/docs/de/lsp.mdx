---
title: LSP Server
description: LzCode lässt sich in Ihren LSP-Server integrieren.
---

LzCode lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

LzCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LzCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer LzCode-Konfiguration anpassen.
