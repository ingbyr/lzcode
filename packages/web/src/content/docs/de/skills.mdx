...
Agent Skills erlauben LzCode, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
LzCode sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft LzCode vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
LzCode listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
