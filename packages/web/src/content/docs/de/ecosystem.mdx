---
title: Ökosystem
description: Mit LzCode erstellte Projekte und Integrationen.
---

Eine Sammlung von Community-Projekten, die auf LzCode basieren.

:::note
Möchten Sie Ihr LzCode-bezogenes Projekt zu dieser Liste hinzufügen? Senden Sie einen PR.
:::
...
| Name                                                                                               | Beschreibung                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Führen Sie LzCode-Sitzungen automatisch in isolierten Daytona-Sandboxes mit Git-Synchronisierung und Live-Vorschauen aus    |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Verfolgen Sie die Nutzung von LzCode mit Wakatime                                                                           |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop-Benachrichtigungen und akustische Warnungen für LzCode-Sitzungen                                                    |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-gestützte automatische Benennung von Zellij-Sitzungen basierend auf dem LzCode-Kontext                                   |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Ermöglichen Sie LzCode-Agenten das verzögerte Laden von Eingabeaufforderungen bei Bedarf mit Skill-Erkennung und -Injektion |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Erweitern Sie LzCode /commands zu einem leistungsstarken Orchestrierungssystem mit granularer Flusskontrolle                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-Benachrichtigungen für LzCode – wissen, wann Aufgaben erledigt sind                                               |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Reibungslose Git-Arbeitsbäume für LzCode                                                                                    |
...
| Name                                                                                       | Beschreibung                                                                 |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-Bot zur Steuerung von LzCode-Sitzungen, basierend auf SDK          |
...
| [portal](https://github.com/hosenur/portal)                                                | Mobile-First-Web UI für LzCode über Tailscale/VPN                          |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Vorlage zum Erstellen von LzCode-Plugins                                   |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-Frontend für LzCode – ein terminalbasierter AI-Coding-Agent         |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK Anbieter für die Verwendung von LzCode über @opencode-ai/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/Desktop-App und VS Code-Erweiterung für LzCode                        |
| [LzCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-Plugin, das LzCode in Obsidians UI einbettet                      |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Eine Open-Source-Alternative zu Claude Cowork, unterstützt von LzCode      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | LzCode Erweiterungsmanager mit portablen, isolierten Profilen.             |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, Web-, Mobil- und Remote-Client-App für LzCode                    |
