---
title: Zen
description: Kuratierte Modellliste direkt von LzCode.
---
...
LzCode Zen ist eine vom LzCode-Team getestete und verifizierte Modellliste.

:::note
LzCode Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in LzCode.
Du meldest dich bei LzCode Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit LzCode funktionieren.
:::
...
LzCode Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

LzCode Zen funktioniert wie jeder andere Provider in LzCode.

1. Melde dich bei **<a href={console}>LzCode Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle LzCode Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner LzCode-Konfiguration hat das Format `opencode/<model-id>`.
...
- MiniMax M2.5 Free ist fuer begrenzte Zeit auf LzCode verfuegbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das fuer begrenzte Zeit kostenlos auf LzCode verfuegbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben LzCode Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und LzCode weiter mit anderen Providern nutzen kannst
