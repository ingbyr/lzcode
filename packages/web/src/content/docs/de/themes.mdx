...
Mit LzCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet LzCode das `opencode`-Theme.
...
LzCode liefert mehrere eingebaute Themes mit.
...
- LzCode optisch ans Terminal anpassen wollen
...
LzCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
