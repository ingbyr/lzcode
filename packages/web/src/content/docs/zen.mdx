---
title: Zen
description: Curated list of models provided by LzCode.
---
...
LzCode Zen is a list of tested and verified models provided by the LzCode team.

:::note
LzCode Zen is currently in beta.
:::

Zen works like any other provider in LzCode. You login to LzCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with LzCode.
:::
...
LzCode Zen is an AI gateway that gives you access to these models.

---

## How it works

LzCode Zen works like any other provider in LzCode.

1. You sign in to **<a href={console}>LzCode Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select LzCode Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your LzCode config
...
- MiniMax M2.5 Free is available on LzCode for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo V2 Flash Free is available on LzCode for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on LzCode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on LzCode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with LzCode as well.
