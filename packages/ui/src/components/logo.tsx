                ...
                <g>
                  <switch>
                    <foreignObject style="overflow: visible; text-align: left;" pointer-events="none" width="100%" height="100%" requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility">
                      <div xmlns="http://www.w3.org/1999/xhtml" style="display: flex; align-items: unsafe center; justify-content: unsafe center; width: 1px; height: 1px; padding-top: 30px; margin-left: 120px;">
                        <div style="box-sizing: border-box; font-size: 0; text-align: center; color: #EA6B66; ">
                          <div style="display: inline-block; font-size: 24px; font-family: 'Comic Sans MS'; color: light-dark(#EA6B66, #d0635f); line-height: 1.2; pointer-events: all; font-weight: bold; white-space: nowrap; ">LzCode</div>
                        </div>
                      </div>
                    </foreignObject>
                    <text x="120" y="37" fill="#EA6B66" font-family="'Comic Sans MS'" font-size="24px" text-anchor="middle" font-weight="bold">LzCode</text>
                  </switch>
                </g>
              </g>
            </g>
