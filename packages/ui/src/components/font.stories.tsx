...
const docs = `### Overview
Loads LzCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>LzCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>LzCode Mono Sample</div>
    </div>
  ),
}
