...
export const dict = {
  ...
  "app.meta.description": "LzCode - Den open source kodningsagent.",

  "home.title": "LzCode | Den open source AI-kodningsagent",
  ...
  "home.what.title": "Hvad er LzCode?",
  "home.what.body":
    "LzCode er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges LzCode af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "LzCode gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er LzCode?",
  "home.faq.a1":
    "LzCode er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg LzCode?",
  ...
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men LzCode virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med LzCode?",
  "home.faq.a4.p1":
    "Ja. LzCode understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge LzCode i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! LzCode er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster LzCode?",
  "home.faq.a6":
    "LzCode er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er LzCode open source?",
  "home.faq.a8.p1": "Ja, LzCode er fuldt open source. Kildekoden er offentlig på",
  ...
  "zen.faq.a3":
    "Zen er ikke for profit. Zen videregiver omkostningerne fra modeludbyderne til dig. Jo mere Zen bruges, desto mere kan LzCode forhandle bedre priser og give dem videre til dig.",
  ...
  "zen.faq.a4.p3":
    "For at dække omkostninger tilføjer LzCode kun et lille betalingsgebyr på $1.23 per $20 saldo-opfyldning.",
  ...
  "zen.faq.a8":
    "Selvom Zen fungerer godt med LzCode, kan du bruge Zen med enhver agent. Følg opsætningsinstruktionerne i din foretrukne kodningsagent.",
  ...
  "zen.problem.subtitle": "Vi løser dette for alle, ikke kun LzCode-brugere.",
  ...
  "zen.how.body": "Selvom vi foreslår, at du bruger Zen med LzCode, kan du bruge Zen med enhver agent.",
  ...
  "go.title": "LzCode Go | Kodningsmodeller til lav pris for alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe LzCode-oplevelsen ud til så mange som muligt. LzCode Go er et lavprisabonnement: $5 for den første måned, derefter $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter ved $5 for den første måned, derefter $10/måned. Du kan bruge det med LzCode eller enhver agent.",
  ...
  "black.meta.title": "LzCode Black | Få adgang til verdens bedste kodningsmodeller",
  "black.meta.description": "Få adgang til Claude, GPT, Gemini og mere med LzCode Black-abonnementer.",
  ...
  "black.workspace.title": "LzCode Black | Vælg workspace",
  ...
  "black.subscribe.success.title": "Du er på LzCode Black-ventelisten",
  ...
  "workspace.black.subscription.message": "Du abonnerer på LzCode Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned LzCode Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned LzCode Black plan.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "LzCode Go" som udbyder i din opencode-konfiguration for at bruge Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer i øjeblikket på LzCode Black eller er på venteliste. Afmeld venligst først, hvis du vil skifte til Go.",
  "workspace.lite.other.message":
    "Et andet medlem i dette workspace abonnerer allerede på LzCode Go. Kun ét medlem pr. workspace kan abonnere.",
  "workspace.lite.promo.description":
    "LzCode Go starter ved {{price}}, derefter $10/måned, og giver pålidelig adgang til populære åbne kodningsmodeller med generøse brugsgrænser.",
  ...
  "download.meta.description": "Download LzCode til macOS, Windows og Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde LzCode til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer LzCode med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "LzCode er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom LzCode fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i LzCode.",
  "download.faq.a6.p2.beforeShare": "Læs mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "LzCode | Enterprise-løsninger til din organisation",
  "enterprise.meta.description": "Kontakt LzCode for enterprise-løsninger",
  "enterprise.hero.title": "Din kode er din egen",
  "enterprise.hero.body1":
    "LzCode fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hvad er LzCode Enterprise?",
  "enterprise.faq.a1":
    "LzCode Enterprise er til organisationer, der vil sikre, at deres kode og data aldrig forlader deres infrastruktur. Det kan gøres med en central konfiguration, der integrerer med dit SSO og din interne AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med LzCode Enterprise?",
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. LzCode gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.q4": "Er mine data sikre med LzCode Enterprise?",
  "enterprise.faq.a4":
    "Ja. LzCode gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "LzCode | Brand",
  "brand.meta.description": "LzCode brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjælper dig med at arbejde med LzCode-brandet.",
  "brand.downloadAll": "Download alle assets",

  "changelog.title": "LzCode | Changelog",
  "changelog.meta.description": "LzCode versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til LzCode",
