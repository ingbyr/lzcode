...
import { InstallationLocal, LZ_BASE_OPENCODE_VERSION } from "@opencode-ai/core/installation/version"
            ...
            add: [
              {
                ...
                version: InstallationLocal ? undefined : LZ_BASE_OPENCODE_VERSION,
              },
            ],
          })
