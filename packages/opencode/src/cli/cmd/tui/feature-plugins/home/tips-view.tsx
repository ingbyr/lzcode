...
const TIPS = [
  ...
  "LzCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "LzCode auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "LzCode uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent LzCode from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencode serve{/highlight} for headless API access to LzCode",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/ingbyr/lzcode{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with LzCode Zen for curated, tested models",
