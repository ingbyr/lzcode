  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all LzCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific LzCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new LzCode session for interacting with AI assistants and managing conversations.",
