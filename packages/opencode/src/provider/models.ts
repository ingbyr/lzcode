...
export namespace ModelsDev {
  ...
  export const JIAORONG_PROVIDER: Provider = {
    id: "jiaorong",
    name: "交融",
    env: ["JIAORONG_API_KEY"],
    npm: "@ai-sdk/openai-compatible",
    api: "https://c4ai.ccccltd.cn/api/compatible/v1",
    models: {
      "jiaorong-instruct": {
        id: "jiaorong-instruct",
        name: "jiaorong-instruct",
        attachment: true,
        reasoning: false,
        tool_call: true,
        temperature: true,
  ...
  export async function get() {
    ...
    result["jiaorong"] = JIAORONG_PROVIDER
    return result
  }
