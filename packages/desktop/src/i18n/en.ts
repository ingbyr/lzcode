export const dict = {
  ...
  "desktop.menu.help.documentation": "LzCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "LzCode CLI binary is missing. Try reinstalling the desktop app.",
