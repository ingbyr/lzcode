export const dict = {
  ...
  "desktop.menu.help.documentation": "LzCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "LzCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
