export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af LzCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af LzCode er blevet downloadet. Vil du installere den og genstarte?",
